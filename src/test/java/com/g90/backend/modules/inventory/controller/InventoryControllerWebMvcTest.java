...
//     @Test
//     void warehouseCanCreateInventoryIssueForPickedSaleOrder() throws Exception {
//         authenticateAs(RoleName.WAREHOUSE);
//         when(inventoryService.createIssue(any())).thenReturn(issueResponse());
...
//                                   "productId": "product-1",
//                                   "quantity": 50,
//                                   "relatedOrderId": "contract-1",
//                                   "reason": "Issue after order picked"
//                                 }
//                                 """))
//                 .andExpect(status().isCreated())
//                 .andExpect(jsonPath("$.code").value("SUCCESS"))
//                 .andExpect(jsonPath("$.data.transactionType").value("ISSUE"))
//                 .andExpect(jsonPath("$.data.relatedOrderId").value("contract-1"));
//     }
...
//     private InventoryMutationResponse issueResponse() {
//         return InventoryMutationResponse.builder()
//                 .transactionId("tx-2")
