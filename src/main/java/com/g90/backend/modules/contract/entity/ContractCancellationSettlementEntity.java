...
@Setter
@Entity
@Table(name = "contract_cancellation_settlements")
public class ContractCancellationSettlementEntity {
    ...
    @Column(name = "settlement_type", length = 40, nullable = false)
    private String settlementType;

    @Column(name = "deposit_refund_amount", precision = 18, scale = 2)
    private BigDecimal depositRefundAmount;

    @Column(name = "compensation_amount", precision = 18, scale = 2)
    private BigDecimal compensationAmount;

    @Column(name = "forfeited_deposit_amount", precision = 18, scale = 2)
    private BigDecimal forfeitedDepositAmount;

    @Column(name = "total_payable_amount", precision = 18, scale = 2)
